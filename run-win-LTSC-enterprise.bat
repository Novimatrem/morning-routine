...
echo.
mklink "C:\Program Files\Git\morning-routine.sh" "C:\Users\%username%\morning-routine.sh"
echo.
echo ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.\wt.exe wt.exe "C:\Program Files\Git\git-bash.exe" -c "bash ../morning-routine.sh"
cd /D "%~dp0"
